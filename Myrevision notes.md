...
To trigger the Jenkins pipeline efficiently, webhooks are used instead of continuous polling (7:40, 13:52). Webhooks notify Jenkins immediately when a specific action, such as a pull request or commit, occurs on the repository (8:12).
